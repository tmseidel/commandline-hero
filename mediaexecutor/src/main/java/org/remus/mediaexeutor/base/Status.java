...
public class Status implements IStatus {
	 ...
	 * @since 3.0
	 */
	public static final IStatus OK_STATUS = new Status(OK, unknownId, OK,
			"ok", null); //$NON-NLS-1$
	/**
	 ...
	 * @since 3.0
	 */
	public static final IStatus CANCEL_STATUS = new Status(CANCEL, unknownId,
			1, "", null); //$NON-NLS-1$
	/**
	 * The severity. One of
	 * <ul>
	 ...
	 */
	public Status(final int severity, final String pluginId, final int code,
	 ...
	 */
	public Status(final int severity, final String pluginId,
			final String message, final Throwable exception) {
		setSeverity(severity);
		setPlugin(pluginId);
		setMessage(message);
	...
	protected void setPlugin(final String pluginId) {
		assert pluginId != null && pluginId.length() > 0;
	...
	protected void setSeverity(final int severity) {
		assert severity == OK || severity == ERROR || severity == WARNING
