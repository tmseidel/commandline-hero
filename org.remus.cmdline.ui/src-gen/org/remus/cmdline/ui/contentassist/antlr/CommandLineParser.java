		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionAccess().getDocAssignment_6_1(), "rule__Function__DocAssignment_6_1");
					put(grammarAccess.getFunctionAccess().getDocurlAssignment_7_1(), "rule__Function__DocurlAssignment_7_1");
					put(grammarAccess.getFunctionAccess().getInputAssignment_8_1(), "rule__Function__InputAssignment_8_1");
					put(grammarAccess.getFunctionAccess().getOutputAssignment_9_1(), "rule__Function__OutputAssignment_9_1");
					put(grammarAccess.getFunctionAccess().getOptionBlocksAssignment_10_1(), "rule__Function__OptionBlocksAssignment_10_1");
